  ...
  <div class="card">
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('project.create') }}" enctype="multipart/form-data" >
        ...
        <p class="card-description"> <b> Project Details .</b> </p>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-12">
                <select class="form-select form-control" name="pro_client_name" required="required" >
                  ...
                  <option value="{{$data->id}},{{$data->client_name}},{{$data->client_address}},{{$data->client_mobile}}">{{$data->client_name}}</option>
                   @endforeach
                </select>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group row">
              ...
              <div class="col-sm-12">
                <textarea class="form-control" name="pro_description" id="summernote"></textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="input-group">
              ...
              <div class="rate"  style="background: black;">
                <!-- <input type="radio" id="star5" name="r_review" required="required" value="5" /> -->
                <label for="star5" title="5">5 stars</label>
                <!-- <input type="radio" id="star4" name="r_review" required="required" value="4" /> -->
                <label for="star4" title="4">4 stars</label>
                <!-- <input type="radio" id="star3" name="r_review" required="required" value="3" /> -->
                <label for="star3" title="3">3 stars</label>
                <!-- <input type="radio" id="star2" name="r_review" required="required" value="2" /> -->
                <label for="star2" title="2">2 stars</label>
                <!-- <input type="radio" id="star1.5" name="r_review" required="required" value="1.5" /> -->
                <!-- <label for="star1" title="1.5">1.5 star</label> -->
                <!-- <input type="radio" id="star1" name="r_review" required="required" value="1" /> -->
                <label for="star1" title="1">1 star</label>
            </div>
            </div>
                <div class="col-md-6">
                <div class="form-group row">
                  <label><strong>Full Star Ratting :</strong> </label><br>
                  <div class="col-sm-12">
                    <select class="form-select form-control" name="full_star" required="required" >
                      <option selected value="">Select Full Star ...</option>
          ...
          <!--Textarea with icon prefix-->
            <div class="md-form amber-textarea active-amber-textarea-2">
              ...
              <textarea id="form24" class="md-textarea form-control" name="text_message" rows="5" required="required"></textarea>
        ...
        <div class="row">
          <div class="col-md-6">
              <label><strong>Project Logo Image :</strong> </label><br>
            ...
            <div class="col-md-6 form-group" style="background: ;">
              ...
              <br><br>
              <input type="file" accept="image/*" name="pro_image" required onchange="preview_image3(event)" class="btn btn-success"  style="width: 100%">
